    ...
    <form class="form"
        ...
        <table class="attendance-detail__table">
            <tbody>
                ...
                <tr class="attendance-detail__row">
                    <th class="attendance-detail__header" scope="col" rowspan="2">出勤・退勤</th>
                    <td class="attendance-detail__description">
                ...
                <tr class="attendance-detail__row">
                    <th class="attendance-detail__header" scope="col" rowspan="2">
                        休憩{{ $loop->iteration === 1 ? '' : $loop->iteration }}
                    </th>
                    <td class="attendance-detail__description">
                ...
                @endunless
                <tr class="attendance-detail__row">
                    <th class="attendance-detail__header" scope="col" rowspan="2">備考</th>
                    @if($attendanceCorrectRequest)
