    ...
    <div class="month-navigation">
        <div class="month-navigation__previous-month">
            <a class="month-navigation__link"
                href="{{ route('adminStaff.show', ['id' => $user->id, 'month' => $currentMonth->copy()->subMonth()->format('Y-m')]) }}">
        ...
        <div class="month-navigation__next-month">
            <a class="month-navigation__link"
                href="{{ route('adminStaff.show',  ['id' => $user->id, 'month' => $currentMonth->copy()->addMonth()->format('Y-m')]) }}">
                翌月
                <span class="arrow">→</span>
            </a>
        </div>
        ...
        <tr class="attendance-list__row">
            ...
            <td class="attendance-list__description">
                ...
                <a class="attendance-list__link"
                    href="{{ route('adminAttendance.edit', ['id' => $attendanceRecordItem['attendance_record']->id]) }}">
                    詳細
                </a>
                @else
